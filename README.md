...
```
This command will create your personal repository under `/Repos/<username>/dbx_dlt_devops`.
...
- To trigger the release pipeline, get the current version from the `dbx_dlt_devops/__init__.py` file and tag the current code version:
```
